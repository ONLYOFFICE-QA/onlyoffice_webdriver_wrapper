...
task :update_chromedriver, [:version] do |_, args|
  ...
  linux_archive = "https://edgedl.me.gvt1.com/edgedl/chrome/chrome-for-testing/#{args[:version]}/linux64/chromedriver-linux64.zip"
  ...
  mac_archive = "https://edgedl.me.gvt1.com/edgedl/chrome/chrome-for-testing/#{args[:version]}/mac-x64/chromedriver-mac-x64.zip"
