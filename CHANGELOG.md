...
* Remove chromedriver `143.0.7499.192`
...
* Remove chromedriver `142.0.7444.175`
...
* Remove chromedriver `141.0.7390.65`
...
* Add chromedriver `142.0.7444.175`

### Changes

* Remove chromedriver `137.0.7151.55`

## 1.39.0 (2025-10-09)

### New Features

* Add chromedriver `141.0.7390.65`

### Changes

* Remove chromedriver `135.0.7049.42`
...
* Remove chromedriver `133.0.6943.53`
...
* Remove chromedriver `132.0.6834.83`
...
* Remove chromedriver `130.0.6723.69`
...
* Remove chromedriver `128.0.6613.86`
...
* Remove chromedriver `126.0.6478.126`
...
* Remove chromedriver `124.0.6367.78`
...
* Add chromedriver `125.0.6422.76`

### Changes

* Remove chromedriver `122.0.6261.128`
...
* Add chromedriver `120.0.6099.71`

### Changes

* Remove chromedriver `115.0.5790.102`
